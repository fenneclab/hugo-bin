...
const extendedBin = new BinWrapper()
  ...
  .src(`${baseUrl}hugo_extended_${hugoVersion}_macOS-ARM64.tar.gz`, 'darwin', undefined) // assume lib "bin-wrapper" was unable to identify arch due to new M1 chip
...
const normalBin = new BinWrapper()
  ...
  .src(`${baseUrl}hugo_${hugoVersion}_macOS-ARM64.tar.gz`, 'darwin', undefined) // assume lib "bin-wrapper" was unable to identify arch due to new M1 chip   
  .src(`${baseUrl}hugo_${hugoVersion}_NetBSD-64bit.tar.gz`, 'netbsd', 'x64')
  .src(`${baseUrl}hugo_${hugoVersion}_OpenBSD-64bit.tar.gz`, 'openbsd', 'x64')
  .src(`${baseUrl}hugo_${hugoVersion}_Windows-32bit.zip`, 'win32', 'x86')
